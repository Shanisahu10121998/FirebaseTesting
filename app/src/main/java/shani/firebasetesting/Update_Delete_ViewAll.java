...
import static shani.firebasetesting.Activity_UI.uId;
import static shani.firebasetesting.MainActivity.databaseReference;

public class Update_Delete_ViewAll extends AppCompatActivity {
    ...
    private void updatedata() {
        ...
        View udialogView = LayoutInflater.from(Update_Delete_ViewAll.this).inflate(R.layout.update_input_field, uviewGroup, false);


        //Now we need an AlertDialog.Builder object
        AlertDialog.Builder builder = new AlertDialog.Builder(Update_Delete_ViewAll.this);
        ...
        //Update
        editTextTitleUpdate = udialogView.findViewById(R.id.edit_Title_update1);
        editTextNotesUpdate = udialogView.findViewById(R.id.edit_Notes_update1);
        editTextTitleUpdate.setText(u_title);
        editTextTitleUpdate.setSelection(u_title.length());

        editTextNotesUpdate.setText(u_note);
        editTextNotesUpdate.setSelection(u_note.length());

        buttonDelete = udialogView.findViewById(R.id.btn_del1);
        buttonUpdate = udialogView.findViewById(R.id.btn_Update1);
